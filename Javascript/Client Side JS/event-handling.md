...
| বিষয় | কাজ |
| :--- | :--- |
| **Bubbling** | ইভেন্ট নিচ থেকে উপরে (Child → Parent) যায়। |
| **Capturing** | ইভেন্ট উপর থেকে নিচে (Parent → Child) আসে। |
| **preventDefault()** | ব্রাউজারের ডিফল্ট কাজ (যেমন লিংকে যাওয়া) থামায়। |
| **stopPropagation()** | ইভেন্টকে অন্য এলিমেন্টে ছড়ানো বন্ধ করে। |
| **stopImmediatePropagation()** | ইভেন্টকে অন্য এলিমেন্টে ছড়ানো বন্ধ করে এবং একই এলিমেন্টের বাকি ইভেন্ট হ্যান্ডলারগুলোকেও থামিয়ে দেয়|
| **CustomEvent** | নিজের তৈরি ইভেন্ট এবং ডেটা (`detail`) পাঠানোর জন্য ব্যবহৃত হয়। |
